...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // Custom App Testing Redirection Logic (Modified for Vercel Portal to prevent 404 errors)
    const playStoreLinks = document.querySelectorAll('.play-store-link');
    playStoreLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            e.preventDefault(); 
            // Routes all button clicks directly to your testing whitelist portal
            const testingUrl = 'https://iskcon-testing-team.vercel.app';
