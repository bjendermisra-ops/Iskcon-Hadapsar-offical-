...
window.addEventListener('load', function () {
  ...
  function _initLenis() {
    ...
    var lenis = new Lenis({
      ...
      smoothWheel:     true,
      smoothTouch:     false, /* Must be false for native mobile swipe */
      wheelMultiplier: 1,
      touchMultiplier: 1.5,
      // FIX: Force Lenis to ignore touches on images and scroll galleries
  ...
  function _initThree() {
    ...
    // Force pointer-events none via JS just to be absolutely safe
